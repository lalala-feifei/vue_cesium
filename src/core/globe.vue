...
class Globe {
  ...
  initGlobe() {
    ...
    Cesium.Ion.defaultAccessToken =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIxNmVjNTk0ZC0xYzY1LTQ0ZWUtOWI2Ny1hMjRiNWI1Y2QwZDAiLCJpZCI6OTAxMywic2NvcGVzIjpbImFzciIsImdjIl0sImlhdCI6MTU1MzIxOTM3Mn0.qi5nscj1ebAxZ0qQX35bKk3c71gBnIUhBmq8wEo3JLY";
    let viewer = new Cesium.Viewer("cesiumContainer", {
      sceneMode: Cesium.SceneMode.SCENE3D,
      scene3DOnly: false,
      sceneLighting: true,
      lightSource: Cesium.LightSource.AMBIENT_AND_DIRECTIONAL,
